        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 sidebar p-0">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link active" href="<?php echo BASE_URL; ?>dashboard/blogs">
            ...
            <div class="col-md-9 col-lg-10 ml-sm-auto p-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1 class="h3">Manage Blog Posts</h1>
                    ...
                    <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="<?php echo $blog['image_url'] ?: 'https://via.placeholder.com/50x50/6c757d/ffffff?text=No+Image'; ?>" 
                                            ...
                                            <td>
                                                ...
                                                <?php if ($blog['content']): ?>
                                                    <br><small class="text-muted"><?php echo substr(strip_tags($blog['content']), 0, 50) . '...'; ?></small>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo BASE_URL; ?>dashboard/blogs?delete_blog=<?php echo $blog['id']; ?>" 
                        ...
                        <?php else: ?>
                            <div class="text-center py-5">
                                ...
                                <p class="text-muted">Share your knowledge by writing your first blog post.</p>
                                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createBlogModal">
    ...
    <div class="modal fade" id="createBlogModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form method="POST" action="<?php echo BASE_URL; ?>dashboard/blogs" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="create_blog" class="btn btn-primary">Create Blog Post</button>
                    </div>
                </form>
            </div>
        </div>
